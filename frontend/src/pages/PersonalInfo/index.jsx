...
export default function PersonalInformation() {
  ...
  const handleEmergencyContactsChange = (index, changes) => {
    ...
    const updatedData = {
      user: id,
      emergencyContacts: updatedEmergency,
    ...
    (isLoading ? (
      ...
      <div>
          ...
          fields={[
            {
              ...
              value: application.profilePicture,
              inputType: "img",
            ...
            },
            {
              ...
              inputType: "text",
            }, // Be cautious about displaying SSN in any application.
            {
              key: "dateOfBirth",
              label: "Date of Birth",
          ...
          fields={[
            {
              key: "apt",
              label: "Building/apt #,",
              value: application.apt,
              inputType: "text",
            },
            {
              key: "streetName",
              label: "street name",
              value: application.streetName,
              inputType: "text",
            },
            {
              key: "city",
          ...
          fields={[
            {
              ...
              label: "Visa title",
              value:
                application.authorizationType !== "Other"
                  ? application.authorizationType
                  : application.otherVisaTitle,
              inputType: "select",
              options: [
            ...
            {
              key: "otherVisaTitle",
              label: "If select Other, please specify",
              value: "",
              inputType: "text",
            },
            {
        ...
        {application.emergencyContacts.length !== 0 &&
          application.emergencyContacts.map((emergencyContact, index) => {
            ...
            return (
              <InfoSection
                ...
                onSave={(changes) =>
                  handleEmergencyContactsChange(index, changes)
                }
              />
            );
          })}
          ...
          fields={[
            {
              ...
              value: application.driverLicense,
              fileName: application.driverLicenseName,
              inputType: "file",
